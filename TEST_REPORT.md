...
## Version 34 Revision 4 - PDF Substitution Boundary Lines - June 30, 2026

- Complete inherited and Version 34 automated regression suite: PASS
- JavaScript syntax validation: PASS
- Vertical substitution divider generated for each affected batting-order row: PASS
- First incoming-player appearance used as the chronological boundary: PASS
- Same-inning outgoing/incoming plate appearances divided inside the inning cell: PASS
- Substitute without a later plate appearance divided after the outgoing player's last recorded cell: PASS
- Multiple substitutions in one lineup position: PASS
- Existing readable substitute-name lines, clipping, ellipsizing, and ASCII `*` markers: PASS
- Two-page letter-size duplex PDF render: PASS
- PDFium visual inspection: PASS
- Poppler visual inspection: PASS
- Version remains 34: PASS

## Version 34 Revision 5 - Prior-Box Substitution Lines - June 30, 2026

- Complete inherited and Version 34 automated regression suite: PASS
- JavaScript syntax validation: PASS
- Substitution divider placed at the right edge of the prior inning box: PASS
- Same-inning outgoing/incoming appearances no longer create an internal cell divider: PASS
- Away-team defensive substitution in the bottom half advances to the next batting inning: PASS
- Multiple substitutions in one lineup position: PASS
- Existing readable substitute-name lines, clipping, ellipsizing, and ASCII `*` markers: PASS
- Two-page letter-size duplex PDF render: PASS
- Version remains 34: PASS
...
## Version 34 Revision 5 - Five MLB Box-Score / Three-Device Simulation Audit - June 30, 2026

- Official June 28 MLB.com line-score targets: 5 games
- Device classes: iPhone 15 Pro portrait, iPad Pro 11 portrait, desktop 1440
- Complete game/device simulations: 15/15 PASS
- Populated field values per game: 423; exact set/collect round-trip: PASS
- Inning-by-inning runs and final R/H/E reproduction: PASS for all five games
- Regulation, unplayed bottom ninth, and 10-inning walk-off finalization: PASS
- Substitution and prior-box vertical divider stress test: PASS
- Pitching-change and six-row PDF pitching layout: PASS
- Page-level horizontal containment on all primary panels: PASS
- Autosave validation: 15/15 PASS
- Full setup-first relaunch recovery: PASS on iPhone, iPad, and desktop
- Actual duplex PDF exports: 8 across all three device classes
- Representative PDFs visually rendered: 5 games / 10 pages; all US Letter and two pages
- PDF clipping, overlap, replacement-glyph, and question-mark fallback audit: PASS
- Complete package regression command: 52 test files PASS
- Production application source changes required: none
- Detailed reports: VERSION_34_FIVE_GAME_DEVICE_AUDIT.md and VERSION_34_FIVE_GAME_DEVICE_AUDIT_REPORT.json
