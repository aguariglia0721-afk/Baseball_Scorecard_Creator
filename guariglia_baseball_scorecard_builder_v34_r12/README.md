# Guariglia Baseball Scorecard Builder — Version 34 Revision 12

This is the cleaned GitHub and Netlify release package. Revision 12 adds a simplified offensive-runner-only field display on iPhone and Android phones while preserving the full iPad and desktop field. It preserves the complete working application while excluding historical screenshots, sample PDFs, audit output, superseded release notes, and the development test suite.
