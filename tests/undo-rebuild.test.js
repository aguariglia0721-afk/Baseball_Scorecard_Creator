...
assert.match(html, /app\.js\?v=34-pa-sync-r6/, 'undo-rebuild JavaScript must be cache-busted');
assert.match(worker, /guariglia-scorecard-v34-pa-sync-r6/, 'service-worker cache must be bumped for the undo fix');
